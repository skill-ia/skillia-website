...
export const ImageZoom = ({
  ...
  <div
    className={cn(
      ...
      // Inherit cursor from parent instead of zoom-in for the zoom button
      '[&_[data-rmiz-btn-zoom]]:absolute [&_[data-rmiz-btn-zoom]]:top-2.5 [&_[data-rmiz-btn-zoom]]:right-2.5 [&_[data-rmiz-btn-zoom]]:bottom-auto [&_[data-rmiz-btn-zoom]]:left-auto [&_[data-rmiz-btn-zoom]]:cursor-inherit',
      ...
      // Inherit cursor from parent (grab/grabbing) instead of zoom-in
      '[&_[data-rmiz-content="found"]_img]:cursor-inherit',
      '[&_[data-rmiz-content="found"]_svg]:cursor-inherit',
      '[&_[data-rmiz-content="found"]_[role="img"]]:cursor-inherit',
      '[&_[data-rmiz-content="found"]_[data-zoom]]:cursor-inherit',
      className
    )}
  >
    <Zoom
      classDialog={cn(
        ...
        // Only apply default backdrop styles if no custom backdropClassName is provided
        !backdropClassName && '[&_[data-rmiz-modal-overlay="visible"]]:bg-background [&_[data-rmiz-modal-overlay="visible"]]:supports-[backdrop-filter]:[&_[data-rmiz-modal-overlay="visible"]]:bg-background/80 [&_[data-rmiz-modal-overlay="visible"]]:supports-[backdrop-filter]:[&_[data-rmiz-modal-overlay="visible"]]:backdrop-blur-md',
